...
def compile_by_folder_structure(root_dir="."):
    # Adjust these paths if you are doing this in Colab vs locally
    ...
    for file_path in all_files:
        try:
            ...
            # THE FIX: Keep the exact participant ID, preserving the '-1'
            raw_pid = str(df['Participant_ID'].iloc[0]).strip()
    ...
    if compiled_events:
        ...
        print(f"Total Unique Participants: {final_df['Participant'].nunique()}") # This should now read 32
